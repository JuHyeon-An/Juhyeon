...
//		검색어를 입력하여 검색하고 검색을 중지하려면 "quit'을 입력하도록 프로그램을 수정하시오.
		...
		while (!input.equals("quit")) {
			...
			for (j = 0; j < names.length; j++) {
				if (names[j].equals(input)) {
					...
					System.out.println(names[q] + "의 영어성적 : " + s[q][0] + "점");
					System.out.println(names[q] + "의 국어성적 : " + s[q][1] + "점");
					System.out.println(names[q] + "의 총점 : " + tot + "점");
					System.out.println(names[q] + "의 평균 : " + avg + "점");
					break; // 동명이인이 있을때는 break 생략
				}
			}
	...
	public static void main(String[] args) {
		ArrayExam4 a3 = new ArrayExam4(); // 객체생성
