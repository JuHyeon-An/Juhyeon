...
public class ServerFrame extends JFrame implements Runnable{
	...
	public void run() {
		...
		try{
			...
			while(true) {
				...
				System.out.println(addr.getHostName()+"ÀÌ(°¡) Á¢¼ÓÇÔ.");
			}
	...
	public JTextField getPort() {
		if (port == null) {
			port = new JTextField();
			port.setText("4444");
			port.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JButton getBtnNewButton() {
		if (btnNewButton == null) {
			btnNewButton = new JButton("Á¢¼Ó");
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					
					Thread t = new Thread(ServerFrame.this);
//					½º·¹µåÀÇ ¸Å°³º¯¼ö´Â Runnable Å¸ÀÔ
					t.start();
					
				}
			});
			btnNewButton.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JButton getBtnNewButton_1() {
		if (btnNewButton_1 == null) {
			...
			btnNewButton_1.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			...
			lblNewLabel_2.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JButton getBtnNewButton_2() {
		if (btnNewButton_2 == null) {
			...
			btnNewButton_2.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JButton getBtnNewButton_3() {
		if (btnNewButton_3 == null) {
			...
			btnNewButton_3.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
	...
	public JLabel getLblNewLabel_3() {
		if (lblNewLabel_3 == null) {
			...
			lblNewLabel_3.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå Regular", Font.PLAIN, 13));
